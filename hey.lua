...
function GUI:CreateMain(config)
    local settings = {
        Name = config.Name or "Exoticlabs",
        title = config.title or config.Title or "Exoticlabs UI",
        ...
        Config = {
            ...
            FolderName = config.Config and config.Config.FolderName or "Exoticlabs",
...
function GUI:Save()
    ...
    local HttpService = game:GetService("HttpService")
    local folderName = GUI.Settings.Config.FolderName or "Exoticlabs"
    local fileName = GUI.Settings.Config.FileName or GUI.Settings.Name or "Exoticlabs"
    local settingsData = {}
